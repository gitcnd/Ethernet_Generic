...
*NOTE*: Tested and working only on an AI-Thinker ESP32S-Cam using a W5500 sheild and the above pins (works OK, and co-exists fine with the Camera, SD-Card, and FLASH etc).
**Should** work on everything if the hardware supports it.
